...
| **Board / List** | **Board** is a direct entry in the primary navigation. **List** is an ordinary destination too: the footer **More** menu on the footer placement, the sidebar under the sidebar placement, and the bottom-bar navigation menu on a phone. The tablet/desktop Header no longer carries a List button. |
