...
- **Goal:** When the compound-engineering plugin is installed, board creation offers a "Compound Engineering" board type whose columns run CE stages as their work engines, with plan approval on by default.
- **Requirements:** R18, R20 (CE-board default-on approval).
...
- **Verification:** End-to-end CE board run produces plan + review + compounded learning artifacts and lands through the PR sub-graph.
