...
- **Test scenarios:**
  ...
  - PR mode: on a PR-mode project, a passing verdict opens a pull request via the existing PR flow instead of enqueueing the merge queue; the task completes as PR-opened.
