...
/*
FNXC:OverlapWaitSynchronization 2026-09-17-01:15:
Adapted from the excluded Fusion-authored commit a87f9b7e's
overlap-wait-persistence.pg.test.ts, against this reimplementation's
packages/core/src/task-store/overlap-wait-ops.ts.
*/
...
pgDescribe("overlap wait persistence", () => {
  ...
  it("keeps merger-published workspace delivery proof after the blocker is deleted", async () => {
