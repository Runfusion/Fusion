 ...
 * Fable 5.1 postdates pinned pi-ai 0.86.1, so register it additively and dedupe against
...
type AnthropicModelLike = Partial<Omit<AnthropicModelRegistration, "name" | "compat" | "thinkingLevelMap">> & {
  id: string;
  name?: unknown;
  provider?: string;
  compat?: unknown;
