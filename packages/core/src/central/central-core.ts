...
import type { ConnectionOptions, ConnectionResult } from "../mesh/node-connection.js";
import { createAuthMaterialSnapshot, createProjectSettingsSnapshot, validateSnapshotEnvelope, type AuthMaterialSnapshot, type ProjectSettingsSnapshot } from "../mesh/shared-mesh-state.js";
import {
