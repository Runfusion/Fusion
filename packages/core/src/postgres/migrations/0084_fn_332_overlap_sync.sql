/*
FNXC:OverlapWaitSynchronization 2026-09-17-00:20:
A file-scope wait remains durable after its display marker clears. The owner task has a composite
foreign key, while blocker identity is a snapshot so deletion or archival of the delivered
predecessor cannot erase synchronization evidence.
*/
