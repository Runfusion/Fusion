...
/** Aggregate the `workflowColumns` flag default-flip criteria (U12, KTD-8) into */
  ...
  public syncAgentTaskLinkOnReassignment( taskId: string, previousAgentId: string | undefined, newAgentId: string | undefined, ): void {
...
/** U8 (KTD-2): record a pre-evaluated plugin gate verdict for a move into */
  ...
  public writeTaskWorkflowSelection(taskId: string, workflowId: string, stepIds: string[]): void {
  ...
  public removeMaterializedSelection(taskId: string): void {
