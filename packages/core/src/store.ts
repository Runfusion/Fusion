...
export class TaskStore extends EventEmitter<TaskStoreEvents> {
  ...
  async updateTask(
    ...
    return this.withTaskLock(id, async () => {
      ...
      if (updates.targetRepoDir === null) {
        task.targetRepoDir = undefined;
      } else if (updates.targetRepoDir !== undefined) {
        task.targetRepoDir = updates.targetRepoDir;
      }
      task.updatedAt = new Date().toISOString();
