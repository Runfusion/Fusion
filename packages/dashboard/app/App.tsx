...
function AppInner() {
  ...
  */
  ...
  const { tasks, isStale, createTask, moveTask, pauseTask, unpauseTask, deleteTask, mergeTask, retryTask, bypassReview, resumeWorkflowStep, resetTask, updateTask, duplicateTask, archiveTask, unarchiveTask, revertTask, archiveAllDone, loadArchivedTasks, loadMoreArchivedTasks, changeArchivedSortMode, archivedSortMode, archivedHasMore, archivedLoadingMore, ingestCreatedTasks, lastFetchTimeMs } = useTasks(
    {
    ...
    <ConfirmDialogProvider skipConfirmations={skipConfirmationDialogs}>
      ...
      */}
      ...
      <AppModals
        ...
        onOpenChatWithPrefill={openChatWithPrefill}
        taskOperations={{ moveTask, deleteTask, mergeTask, archiveTask, revertTask, retryTask, pauseTask, unpauseTask, bypassReview, resumeWorkflowStep, resetTask, duplicateTask }}
