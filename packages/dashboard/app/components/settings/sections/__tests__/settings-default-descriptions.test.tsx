...
const SETTING_DESCRIPTION_KEYS: Record<string, string> = {
  ...
  */
  ...
  Settings Memory section; help states the schema default (on), matching
  DEFAULT_SETTINGS in settings-schema.ts.
  */
...
const NOT_SURFACED_ALLOWLIST: Record<string, string> = {
  ...
  */
  ...
  executionGlobalFallbackProvider: "configured by the global Executor fallback picker, not a plain description field",
  executionGlobalFallbackModelId: "configured by the global Executor fallback picker, not a plain description field",
  executionGlobalFallbackThinkingLevel: "inline thinking companion for the global Executor fallback picker",
  executionGlobalFallbackCredentialInstanceId: "inline credential companion for the global Executor fallback picker",
  planningGlobalFallbackProvider: "configured by the global Planner fallback picker, not a plain description field",
  planningGlobalFallbackModelId: "configured by the global Planner fallback picker, not a plain description field",
  planningGlobalFallbackThinkingLevel: "inline thinking companion for the global Planner fallback picker",
  planningGlobalFallbackCredentialInstanceId: "inline credential companion for the global Planner fallback picker",
  validatorGlobalFallbackProvider: "configured by the global Reviewer fallback picker, not a plain description field",
  validatorGlobalFallbackModelId: "configured by the global Reviewer fallback picker, not a plain description field",
  validatorGlobalFallbackThinkingLevel: "inline thinking companion for the global Reviewer fallback picker",
  validatorGlobalFallbackCredentialInstanceId: "inline credential companion for the global Reviewer fallback picker",
  mergerGlobalFallbackProvider: "configured by the global Merger fallback picker, not a plain description field",
  mergerGlobalFallbackModelId: "configured by the global Merger fallback picker, not a plain description field",
  mergerGlobalFallbackThinkingLevel: "inline thinking companion for the global Merger fallback picker",
  mergerGlobalFallbackCredentialInstanceId: "inline credential companion for the global Merger fallback picker",
  ...
  Pipeline roles are independently configurable in Project Models again. Their provider/model, thinking, credential, and retry companions are bespoke picker state rather than standalone description rows; they are not historical workflow-moved keys.
  */
  planningProvider: "configured by the project Planner model picker, not a plain description field",
  planningModelId: "configured by the project Planner model picker, not a plain description field",
  planningThinkingLevel: "inline thinking companion for the project Planner model picker",
  planningCredentialInstanceId: "inline credential companion for the project Planner model picker",
  planningFallbackProvider: "configured by the project Planner fallback picker, not a plain description field",
  planningFallbackModelId: "configured by the project Planner fallback picker, not a plain description field",
  planningFallbackThinkingLevel: "inline thinking companion for the project Planner fallback picker",
  planningFallbackCredentialInstanceId: "inline credential companion for the project Planner fallback picker",
  executionProvider: "configured by the project Executor model picker, not a plain description field",
  executionModelId: "configured by the project Executor model picker, not a plain description field",
  executionThinkingLevel: "inline thinking companion for the project Executor model picker",
  executionCredentialInstanceId: "inline credential companion for the project Executor model picker",
  executionFallbackProvider: "configured by the project Executor fallback picker, not a plain description field",
  executionFallbackModelId: "configured by the project Executor fallback picker, not a plain description field",
  executionFallbackThinkingLevel: "inline thinking companion for the project Executor fallback picker",
  executionFallbackCredentialInstanceId: "inline credential companion for the project Executor fallback picker",
  validatorProvider: "configured by the project Reviewer model picker, not a plain description field",
  validatorModelId: "configured by the project Reviewer model picker, not a plain description field",
  validatorThinkingLevel: "inline thinking companion for the project Reviewer model picker",
  validatorCredentialInstanceId: "inline credential companion for the project Reviewer model picker",
  validatorFallbackProvider: "configured by the project Reviewer fallback picker, not a plain description field",
  validatorFallbackModelId: "configured by the project Reviewer fallback picker, not a plain description field",
  validatorFallbackThinkingLevel: "inline thinking companion for the project Reviewer fallback picker",
  validatorFallbackCredentialInstanceId: "inline credential companion for the project Reviewer fallback picker",
  ...
  */
  ...
  scriptMetadata: "managed with scripts outside the plain Settings description fields",
