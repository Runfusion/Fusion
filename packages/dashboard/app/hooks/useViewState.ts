...
export type TaskView = "board" | "list" | "agents" | "missions" | "chat" | "documents" | "roadmaps" | "skills" | "mailbox" | "insights";
...
export function useViewState(options: UseViewStateOptions): UseViewStateResult {
  ...
  const [taskView, setTaskView] = useState<TaskView>(() => {
    ...
    if (saved === "board" || saved === "list" || saved === "agents" || saved === "missions" || saved === "chat" || saved === "documents" || saved === "roadmaps" || saved === "skills" || saved === "mailbox" || saved === "insights") return saved as TaskView;
    return "board";
  });
  ...
  useEffect(() => {
    ...
    if (saved === "board" || saved === "list" || saved === "agents" || saved === "missions" || saved === "chat" || saved === "documents" || saved === "roadmaps" || saved === "skills" || saved === "mailbox" || saved === "insights") {
