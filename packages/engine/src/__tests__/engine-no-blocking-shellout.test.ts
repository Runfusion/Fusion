...
const allowlist: AllowlistEntry[] = [
  ...
  */
  ...
  { file: "src/merge/integration-branch.ts", line: 146, primitive: "execFileSync", signature: 'execFileSync("git", ["branch", "--no-track", branch, remoteRef], {', reason: SHORT_GIT_PLUMBING },
