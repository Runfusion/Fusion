      ...
      */
      ...
      try {
        result = await acquireWorkspaceRepoWorktree({
          ...
          ...(() => {
            const taskDir = resolveWorkspaceTaskWorktreeDir(workspaceRootDir, settings, resolveWorkspaceTaskDirSegment(freshTask));
