...
import { isBackwardMoveOutOfPlanning as isBackwardMoveOutOfPlanningImpl } from "./executor/backward-move-out-of-planning.js";
export { isBackwardMoveOutOfPlanning as isBackwardMoveOutOfPlanningFree } from "./executor/backward-move-out-of-planning.js";
...
export class TaskExecutor {
  ...
  */
  ...
  private isBackwardMoveOutOfPlanning(taskId: string, from: string, to: string, moveLanes: TaskMoveLanes | undefined): boolean {
    return isBackwardMoveOutOfPlanningImpl(this.store, taskId, from, to, moveLanes);
  }
      ...
      */
      ...
      if (latestTask.column === bounceLanes.wip || latestTask.column === bounceLanes.review) {
        ...
        if (preserveResumeState) {
          ...
          await this.store.moveTask(taskId, await resolveReboundColumnFor(this.store, taskId), { preserveWorktree: true });
        }
    ...
    try {
      ...
      */
      if (
        ...
        try {
          const tasksDir = typeof this.store.getTasksDir === "function"
