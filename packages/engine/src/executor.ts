    ...
    return runImplementationImpl(
      {
        ...
        getRunContextFor: (id) => this.getRunContextFor(id),
        persistTokenUsage: (...a: unknown[]) => (this as any).persistTokenUsage(...a),
        markGraphExecuteSelfRequeued: (...a: unknown[]) => (this as any).markGraphExecuteSelfRequeued(...a),
        clearPausedAborted: (...a: unknown[]) => (this as any).clearPausedAborted(...a),
        deleteActiveSession: (...a: unknown[]) => (this as any).deleteActiveSession(...a),
        hasActiveWorktreeBinding: (...a: unknown[]) => (this as any).hasActiveWorktreeBinding(...a),
        persistTaskTokenUsage: (...a: unknown[]) => (this as any).persistTaskTokenUsage(...a),
        handleDepAbortCleanup: (...a: unknown[]) => (this as any).handleDepAbortCleanup(...a),
        parkApprovalSuspension: (...a: unknown[]) => (this as any).parkApprovalSuspension(...a),
        scheduleCompletedTaskWatchdog: (...a: unknown[]) => (this as any).scheduleCompletedTaskWatchdog(...a),
        shouldDeferCompletionForGlobalPause: (...a: unknown[]) => (this as any).shouldDeferCompletionForGlobalPause(...a),
        clearCompletedTaskWatchdog: (...a: unknown[]) => (this as any).clearCompletedTaskWatchdog(...a),
        resolveResumeLanes: (...a: unknown[]) => (this as any).resolveResumeLanes(...a),
        transitionReviewAddressing: (...a: unknown[]) => (this as any).transitionReviewAddressing(...a),
        buildActionGateContext: (...a: unknown[]) => (this as any).buildActionGateContext(...a),
        buildPermanentAgentGatingContext: (...a: unknown[]) => (this as any).buildPermanentAgentGatingContext(...a),
        resolveMcpServers: (...a: unknown[]) => (this as any).resolveMcpServers(...a),
        captureModifiedFiles: (...a: unknown[]) => (this as any).captureModifiedFiles(...a),
        handleNonContinuableSessionError: (...a: unknown[]) => (this as any).handleNonContinuableSessionError(...a),
        signalTaskComplete: (...a: unknown[]) => (this as any).signalTaskComplete(...a),
        getAutoRecoveryDispatcher: (...a: unknown[]) => (this as any).getAutoRecoveryDispatcher(...a),
        registerConfiguredCommandController: (...a: unknown[]) => (this as any).registerConfiguredCommandController(...a),
        unregisterConfiguredCommandController: (...a: unknown[]) => (this as any).unregisterConfiguredCommandController(...a),
        tryBootstrapMisbindingRecovery: (...a: unknown[]) => (this as any).tryBootstrapMisbindingRecovery(...a),
        addActiveWorktree: (...a: unknown[]) => (this as any).addActiveWorktree(...a),
        getAuthoritativeAssignedAgent: (...a: unknown[]) => (this as any).getAuthoritativeAssignedAgent(...a),
        resolveSeamColumnAgent: (...a: unknown[]) => (this as any).resolveSeamColumnAgent(...a),
        sendTaskBackForFix: (...a: unknown[]) => (this as any).sendTaskBackForFix(...a),
        runWithExecutorSemaphore: (...a: unknown[]) => (this as any).runWithExecutorSemaphore(...a),
        resetStepsIfWorkLost: (...a: unknown[]) => (this as any).resetStepsIfWorkLost(...a),
        recoverMissingWorktreeSessionStartFailure: (...a: unknown[]) => (this as any).recoverMissingWorktreeSessionStartFailure(...a),
        captureExecutorTokenUsageBaseline: (...a: unknown[]) => (this as any).captureExecutorTokenUsageBaseline(...a),
        setActiveSession: (...a: unknown[]) => (this as any).setActiveSession(...a),
        renewTaskLease: (...a: unknown[]) => (this as any).renewTaskLease(...a),
        resolveTaskCustomFieldDefs: (...a: unknown[]) => (this as any).resolveTaskCustomFieldDefs(...a),
        getCompletedTaskFinalizationDecision: (...a: unknown[]) => (this as any).getCompletedTaskFinalizationDecision(...a),
        markCompletionFinalized: (...a: unknown[]) => (this as any).markCompletionFinalized(...a),
        handoffTaskToReview: (...a: unknown[]) => (this as any).handoffTaskToReview(...a),
        handleImplicitTaskDoneRefusal: (...a: unknown[]) => (this as any).handleImplicitTaskDoneRefusal(...a),
        terminateAllChildren: (...a: unknown[]) => (this as any).terminateAllChildren(...a),
        maybeDispatchWorkflowWorkEngine: (...a: unknown[]) => (this as any).maybeDispatchWorkflowWorkEngine(...a),
        resolveEffectivePrincipalId: (...a: unknown[]) => (this as any).resolveEffectivePrincipalId(...a),
        shouldDeferForHeartbeat: (...a: unknown[]) => (this as any).shouldDeferForHeartbeat(...a),
        finalizeMergeConfirmedWorkflowGraphTask: (...a: unknown[]) => (this as any).finalizeMergeConfirmedWorkflowGraphTask(...a),
        cleanupMergeStateForReverification: (...a: unknown[]) => (this as any).cleanupMergeStateForReverification(...a),
        createWorktree: (...a: unknown[]) => (this as any).createWorktree(...a),
        emitWorktreeReanchoredAudit: (...a: unknown[]) => (this as any).emitWorktreeReanchoredAudit(...a),
        buildInjectedRuntimeEnv: (...a: unknown[]) => (this as any).buildInjectedRuntimeEnv(...a),
        reconcileStepsFromGitHistory: (...a: unknown[]) => (this as any).reconcileStepsFromGitHistory(...a),
        setActiveStepExecutor: (...a: unknown[]) => (this as any).setActiveStepExecutor(...a),
        captureWorkspaceModifiedFiles: (...a: unknown[]) => (this as any).captureWorkspaceModifiedFiles(...a),
        runExecutorDeterministicVerification: (...a: unknown[]) => (this as any).runExecutorDeterministicVerification(...a),
        attemptExecutorVerificationFix: (...a: unknown[]) => (this as any).attemptExecutorVerificationFix(...a),
        deleteActiveStepExecutor: (...a: unknown[]) => (this as any).deleteActiveStepExecutor(...a),
        createTaskUpdateTool: (...a: unknown[]) => (this as any).createTaskUpdateTool(...a),
        createTaskLogTool: (...a: unknown[]) => (this as any).createTaskLogTool(...a),
        createTaskLogsReadTool: (...a: unknown[]) => (this as any).createTaskLogsReadTool(...a),
        createTaskCreateTool: (...a: unknown[]) => (this as any).createTaskCreateTool(...a),
        createTaskAddDepTool: (...a: unknown[]) => (this as any).createTaskAddDepTool(...a),
        createTaskDoneTool: (...a: unknown[]) => (this as any).createTaskDoneTool(...a),
        createSpawnAgentTool: (...a: unknown[]) => (this as any).createSpawnAgentTool(...a),
        createTaskDocumentWriteTool: (...a: unknown[]) => (this as any).createTaskDocumentWriteTool(...a),
        createTaskDocumentReadTool: (...a: unknown[]) => (this as any).createTaskDocumentReadTool(...a),
        createTaskFileScopeAddTool: (...a: unknown[]) => (this as any).createTaskFileScopeAddTool(...a),
        createArtifactListTool: (...a: unknown[]) => (this as any).createArtifactListTool(...a),
        createArtifactViewTool: (...a: unknown[]) => (this as any).createArtifactViewTool(...a),
        createArtifactRegisterTool: (...a: unknown[]) => (this as any).createArtifactRegisterTool(...a),
        createWorkflowListTool: (...a: unknown[]) => (this as any).createWorkflowListTool(...a),
        createWorkflowGetTool: (...a: unknown[]) => (this as any).createWorkflowGetTool(...a),
        createWorkflowValidateTool: (...a: unknown[]) => (this as any).createWorkflowValidateTool(...a),
        createWorkflowSelectTool: (...a: unknown[]) => (this as any).createWorkflowSelectTool(...a),
        createTaskPromoteTool: (...a: unknown[]) => (this as any).createTaskPromoteTool(...a),
        createWorkflowCreateTool: (...a: unknown[]) => (this as any).createWorkflowCreateTool(...a),
        createWorkflowUpdateTool: (...a: unknown[]) => (this as any).createWorkflowUpdateTool(...a),
        createWorkflowDeleteTool: (...a: unknown[]) => (this as any).createWorkflowDeleteTool(...a),
        createWorkflowSettingsTool: (...a: unknown[]) => (this as any).createWorkflowSettingsTool(...a),
        createTraitListTool: (...a: unknown[]) => (this as any).createTraitListTool(...a),
        resolveInstructionsForRole: (...a: unknown[]) => (this as any).resolveInstructionsForRole(...a),
        finalizeAlreadyReviewedTask: (...a: unknown[]) => (this as any).finalizeAlreadyReviewedTask(...a),
        handleBranchConflict: (...a: unknown[]) => (this as any).handleBranchConflict(...a),
        handleNonContinuableSessionRetry: (...a: unknown[]) => (this as any).handleNonContinuableSessionRetry(...a),
        resumeApprovalAfterUnwindIfNeeded: (...a: unknown[]) => (this as any).resumeApprovalAfterUnwindIfNeeded(...a),
      },
      task,
      graphCompletion,
