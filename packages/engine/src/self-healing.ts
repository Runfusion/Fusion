...
export class SelfHealingManager extends SelfHealingGitEvidence {
  ...
  */
  ...
  private async canResolveWorkflowDefinition(workflowId: string): Promise<boolean> {
    ...
    if (isBuiltinWorkflowId(workflowId)) return true;
    try {
