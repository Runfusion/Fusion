  ...
  */
  ...
  async recoverMissingWorktreeReviewFailures(): Promise<number> {
    try {
      ...
      */
      ...
      /*
      FNXC:WorkflowLifecycleColumns 2026-07-30-20:20 (PR #2745 review — greptile P1: "recovery lanes are not
  ...
  async finalizeOrphanedPlanningSegments(): Promise<number> {
    ...
    for (const task of tasks) {
      ...
      if (applied) {
        finalized++;
        // FNXC:TaskTiming 2026-07-30-12:00: this recovery is operator-auditable
