...
export default interface Resources {
  "app": {
    ...
    "nav": {
      ...
      "recommendationsUnreadAriaLabel_one": "{{count}} new recommendation",
      "recommendationsUnreadAriaLabel_other": "{{count}} new recommendations",
      "recommendationsUnreadDotAriaLabel": "New recommendations",
      "research": "Research",
      "resizeSidebar": "Resize sidebar",
