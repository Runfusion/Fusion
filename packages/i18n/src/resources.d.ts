  ...
  "app": {
    ...
    "settings": {
      ...
      "worktrees": {
        ...
        "branchTicketEGPRD1234MySlug": "Branch / ticket (e.g., prd-1234-my-slug)",
        "tryAgain": "Try again",
