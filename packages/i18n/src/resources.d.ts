...
export default interface Resources {
  "app": {
    ...
    "setup": {
      ...
      "antigravityCli": {
        "active": "✓ Active",
        "binaryNotFound": "`agy` not found on PATH",
        "binaryPathHelp": "Leave blank to use PATH auto-detection (`agy`).",
        "binaryPathLabel": "Antigravity CLI binary path",
        "binaryPathPlaceholder": "/usr/local/bin/agy",
        "connected": "Connected{{version}}",
        "description": "Route AI calls through your local Google Antigravity runtime.",
        "detectedPrompt": "Detected. Click Enable to route calls through Antigravity CLI.",
        "disable": "Disable",
        "disabling": "Disabling…",
        "enable": "Enable",
        "enabling": "Enabling…",
        "notConnected": "✗ Not connected",
        "pathCleared": "Binary path cleared; PATH auto-detection is active.",
        "pathSaved": "Binary path saved and tested.",
        "probing": "Probing local CLI…",
        "providerName": "Google Antigravity — via agy CLI",
        "saveAndTestPath": "Save & Test",
        "savingPath": "Saving…",
        "test": "Test",
        "testing": "Testing…"
      },
