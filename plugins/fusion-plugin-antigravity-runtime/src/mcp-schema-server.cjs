...
const bridgeUrl = process.env.FUSION_ANTIGRAVITY_TOOL_BRIDGE_URL;
const bridgeToken = process.env.FUSION_ANTIGRAVITY_TOOL_BRIDGE_TOKEN;
if (!schemaPath || !bridgeUrl || !bridgeToken) {
  process.stderr.write("fusion-antigravity-mcp-server: missing schema path or FUSION_ANTIGRAVITY_TOOL_BRIDGE_URL\n");
  process.exit(1);
}
